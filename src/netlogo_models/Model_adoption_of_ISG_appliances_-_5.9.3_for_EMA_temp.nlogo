...
;  set electricity_price_night_fix 0.15
;  set difference_between_day_and_night_price 0.2
...
;            if household_number = 0 [print "" print monthly_electricity_costs print item 4 ISG_appliance_part_1 print item 5 ISG_appliance_part_1 print item 6 ISG_appliance_part_1 print k]
            ...
            let p m - n
;            if household_number = 0 [print mean memory_electricity_price_day print mean memory_electricity_price_night print m print n print p]
...
;          if household_number = 300 [print total_positive_information
