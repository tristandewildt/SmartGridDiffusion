...
to setup_adopter_properties
  ...
  set A_S_L_valuation_of_savings_full_rational_1 0 ;-5
  set A_S_L_valuation_of_savings_full_rational_2 0 ;-2.5
...
to setup_for_ema
  ...
  set Amount_of_month_before_purchase_enthousiasm_stops 0
