...
class DiffusionModelInterface(NetLogoModelStructureInterface):
    model_file = r'/Model_adoption_of_ISG_appliances_-_5.9.2_for_EMA_temp.nlogo'
...
#                      ParameterUncertainty((0.5,1.5),"A_S_L_Combined_interaction_long_multiplicator"),
                     ParameterUncertainty((0.5,1),"A_S_L_preferred_information_source_innovator_1"),
...
#                     ParameterUncertainty((0,0),"A_S_L_preferred_information_source_early_adopter_5"),
                     ...
                     ParameterUncertainty((0.15,0.45),"A_S_L_preferred_information_source_early_majority_2"),
...
#                     ParameterUncertainty((0,0),"A_S_L_preferred_information_source_early_majority_5"),
                     ...
                     ParameterUncertainty((0,0.1),"A_S_L_preferred_information_source_late_majority_2"),
                     ParameterUncertainty((0.35,0.65),"A_S_L_preferred_information_source_late_majority_3"),
...
#                      ParameterUncertainty((0,0),"A_S_L_preferred_information_source_laggard_2"),
                     ParameterUncertainty((0,0.2),"A_S_L_preferred_information_source_laggard_3"),
                     ParameterUncertainty((0.1,0.3),"A_S_L_preferred_information_source_laggard_4"),
                     ParameterUncertainty((0.2,0.4),"A_S_L_preferred_information_source_laggard_5"),
...
#                      ParameterUncertainty((0,0.01),"Probability_of_failure_list_4"),
                     ParameterUncertainty((12,75),"introduction_phase",integer=True),
                     ParameterUncertainty((12,75),"growth_phase",integer=True),
#                      ParameterUncertainty((100,300),"maturity_phase",integer=True),
                     ParameterUncertainty((1,5),"memory",integer=True),
...
#                      ParameterUncertainty((0.5,1.5),"variation_of_SD_normal_distribution_properties_of_adopters"),
                     ParameterUncertainty((0.93,1),"Learning_rate_appliances_1"),
...
#                      ParameterUncertainty((0.5,0.7),"Night_percentage_of_day_price"),
                       ParameterUncertainty((24,74),"Duration_information_complexity_validity",integer=True),
...
#                        ParameterUncertainty((2,6),"memory_calculation_of_savings",integer=True), #if bounded rationality
                       ParameterUncertainty((0.05,0.2),"valuation_per_household_encountered_early_adopters"),
                       ParameterUncertainty((0.05,0.1),"valuation_per_household_encountered_late_majority"),
                       ParameterUncertainty((0.4,1),"social_value_difference_to_mean"),
                        ParameterUncertainty((0.5,1.5),"change_threshold_to_reach_for_weights_information_complexity_only_per_process"),
                        ParameterUncertainty((0.5,1.5),"change_threshold_to_reach_for_weights_information_reliability_only_per_process"),
                        ParameterUncertainty((0.5,1.5),"change_threshold_to_reach_for_weights_information_data_leak_only_per_process"),
                        ParameterUncertainty((0.5,1.5),"change_threshold_to_reach_for_weights_information_savings_only_per_process"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_complexity_1"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_complexity_2"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_complexity_3"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_complexity_4"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_complexity_5"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_reliability_1"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_reliability_2"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_reliability_3"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_reliability_4"),
                        ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_reliability_5"),
...
#                         ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_savings_1"),
#                         ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_savings_2"),
#                         ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_savings_3"),
#                         ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_savings_4"),
#                         ParameterUncertainty((0.5,1.5),"threshold_to_reach_for_weights_information_savings_5"),
